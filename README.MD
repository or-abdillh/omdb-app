...
- [See documentation](vitejs.dev/guide/#scaffolding-your-first-vite-project)
...
- if you get an <bold>error on esbuild</bold> try to install manual, run this code before <code>npm run dev</code> : <code>node node_modules/esbuild/install.js</code> to install manually
