...
-  * if you get an error on esbuild not installed *, run this code before <code>npm run dev</code> : <code>node node_modules/esbuild/install.js</code> to install manually
